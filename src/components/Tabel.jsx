...
function Tabel({ data,onEdit,onDelete }) {
    return (
        <div className='tabel'>
            <div className="text-5xl font-bold text-center p-5 bg-blue-900 text-white"><h1>Table</h1></div>
            {
                data.length === 0 ? (<h1 className='text-center mt-40 text-2xl'>No data found</h1>) : (<div className="table">
